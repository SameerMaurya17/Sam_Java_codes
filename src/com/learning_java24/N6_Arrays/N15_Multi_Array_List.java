...
//         Initialization
        ...
        System.out.println(list.get(0)); // Printing a particular row of a matrix
        System.out.println(list.get(0).get(0)); // Printing a particular element of a row of a matrix
